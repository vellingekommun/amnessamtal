...
class ConfirmationMail extends Mailable
{
    ...
    {
        return $this->subject("Dina bokningar för " . $this->student_name)->view('emails.confirmation')->with(['slots' => $this->slots, 'token' => $this->token, 'starts_at' => $this->starts_at, 'information_message' => $this->information_message]);
    }
}
